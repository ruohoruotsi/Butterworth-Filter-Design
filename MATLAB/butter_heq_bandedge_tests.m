%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% IOHAVOC: butter heq tests -- new bandedge stuff
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if0 =(f1 + f2)/2    % center freq for parametric
iDf = f2 - f1;       % delta_freq -> bandwidth
...
[w00, Dww] = bandedge(w1, w2, 1); 

 Dw = w2 - w1;
 if w2==pi, 
      w0=pi;
 else 
      w0 = acos(sin(w1+w2)/(sin(w1)+sin(w2)));
 end
